...
// ../../ar-tracking/dist/src/components/AR-SLAM-camera.js
var ARSLAMCamera = class extends ARCamera {
  _trackingImpl;
  init = () => {
    this._trackingImpl = ARSession.getSessionForEngine(this.engine).getTrackingProvider(TrackingType.SLAM, this);
  };
  start() {
    if (!this.object.getComponent("view")) {
      throw new Error("AR-camera requires a view component");
...
__publicField(ARSLAMCamera, "TypeName", "ar-slam-camera");
...
// js/hit-test-location-root.ts
var HitTestLocationRoot = class extends Component2 {
  camera;
  xrHitTestSource = null;
  mesh;
  start() {
    const arSession2 = ARSession.getSessionForEngine(this.engine);
    arSession2.onSessionStart.add(this.onSessionStart);
    arSession2.onSessionEnd.add(this.onSessionEnd);
    this.mesh = this.object.getComponent(MeshComponent2);
...
__publicField(HitTestLocationRoot, "TypeName", "hit-test-location-root");
__decorateClass([
  property2.object()
], HitTestLocationRoot.prototype, "camera", 2);
...
// js/hit-test-location-xr8.ts
var HitTestLocationXR8 = class extends Component2 {
  camera;
  _tracking = false;
...
__publicField(HitTestLocationXR8, "TypeName", "hit-test-location-xr8");
__decorateClass([
  property2.object()
], HitTestLocationXR8.prototype, "camera", 2);

// js/spawn-mesh-on-reticle.ts
var SpawnMeshOnReticle = class extends Component2 {
  mesh;
  material;
  start() {
    const arSession2 = ARSession.getSessionForEngine(this.engine);
    arSession2.onSessionStart.add(this.onSessionStart.bind(this));
    arSession2.onSessionEnd.add(this.onSessionEnd.bind(this));
  }
  onSessionStart(provider) {
    if (provider instanceof WebXRProvider) {
      provider.xrSession.addEventListener(
        "select",
        this.spawnMesh
      );
    } else {
  ...
  onSessionEnd(provider) {
    if (provider instanceof WebXRProvider) {
      provider.xrSession.removeEventListener(
        "select",
        this.spawnMesh
      );
    } else {
...
__publicField(SpawnMeshOnReticle, "TypeName", "spawn-mesh-on-reticle");
__decorateClass([
  property2.mesh()
], SpawnMeshOnReticle.prototype, "mesh", 2);
__decorateClass([
  property2.material()
], SpawnMeshOnReticle.prototype, "material", 2);
...
//# sourceMappingURL=SLAMCamera-bundle.js.map
