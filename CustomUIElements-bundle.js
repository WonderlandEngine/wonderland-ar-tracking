...
// node_modules/qrcode-with-logos/dist/qrcode-with-logos.es5.js
...
var drawLogo = function(_a) {
  ...
  image.src = logoSrc;
  var drawLogoWithImage = function(image2) {
    ctx.drawImage(image2, logoXY, logoXY, logoWidth, logoWidth);
  };
  var drawLogoWithCanvas = function(image2) {
...
var QrCodeWithLogo = function() {
  function QrCodeWithLogo2(option) {
  ...
  QrCodeWithLogo2.prototype.toCanvas = function() {
    var _this = this;
  ...
  QrCodeWithLogo2.prototype.toImage = function() {
    return toImage.call(this, this.option);
  };
  QrCodeWithLogo2.prototype.downloadImage = function(name) {
    return __awaiter(this, void 0, void 0, function() {
  ...
  QrCodeWithLogo2.prototype.getCanvas = function() {
  ...
  return QrCodeWithLogo2;
}();
var qrcode_with_logos_es5_default = QrCodeWithLogo;

// ../../ar-provider-8thwall/dist/src/xr8-provider.js
var QRCode2 = __toESM(require_qrcode2(), 1);
...
// js/custom-xr-ui-handler.ts
var CustomUIHandler = class extends Component2 {
  start() {
  ...
  async handlePermissionFail(error) {
    console.log("Permission failed", error);
    const html = (await (await fetch("xr8-ui/failedPermissionsOverlay.html")).text()).replace("${REASON}", error.message);
  ...
  handleIncompatibleDevice = async () => {
    ...
    const overlay = this.showOverlay(html);
    new qrcode_with_logos_es5_default({
      content: document.location.href,
      width: 350,
      image: overlay.querySelector("#xr8-overlay-qr-code"),
      logo: {
        src: "ball.png"
      }
    }).toImage();
...
__publicField(CustomUIHandler, "TypeName", "custom-xr8-ui-handler");
...
qrcode-with-logos/dist/qrcode-with-logos.es5.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=CustomUIElements-bundle.js.map
