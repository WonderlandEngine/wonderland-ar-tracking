    ...
    return (() => {
            ...
            r = {
                56: (e, t, r) => {
                    var a,
                        n =
                            ...
                            function (e) {
                                ...
                                var u,
                                    l,
                                    p = t.print || console.log.bind(console),
                                ...
                                function S(e) {
                                    var t = P(e) + 1,
                                        r = _r(t);
                                    return (r && O(e, E, r, t), r);
                                }
                                function B(e, t) {
                                    for (var r = 0; r < e.length; ++r)
                                        E[t++ >> 0] = e.charCodeAt(r);
                                    E[t >> 0] = 0;
                                }
                                function C() {
                                    var e = m.buffer;
                                    ((v = e),
                                        ...
                                        (t.HEAP16 = T = new Int16Array(e)),
                                        (t.HEAP32 = x = new Int32Array(e)),
                                        (t.HEAPU8 = A = new Uint8Array(e)),
                                        (t.HEAPU16 = R = new Uint16Array(e)),
                                        (t.HEAPU32 = k = new Uint32Array(e)),
                                        (t.HEAPF32 = L = new Float32Array(e)),
                                        (t.HEAPF64 = F = new Float64Array(e)));
                                }
                                var D,
                                    U = [],
                                    V = [],
                                ...
                                if (
                                    String.prototype.startsWith
                                        ...
                                        : 0 !==
                                          Q.indexOf('data:application/octet-stream;base64,')
                                ) {
                                    var ee = Q;
                                    Q = t.locateFile ? t.locateFile(ee, f) : f + ee;
                                }
                                function te(e) {
                                    for (; 0 < e.length; ) {
                                        var r = e.shift();
                                ...
                                function ne(e, t) {
                                    for (var r = 0, a = e.length - 1; 0 <= a; a--) {
                                        var n = e[a];
                                        '.' === n
                                            ? e.splice(a, 1)
                                            : '..' === n
                                    ...
                                    de = {
                                        ...
                                        createNode: function (e, t, r, a) {
                                            ...
                                            return (
                                                ...
                                                16384 == (61440 & (r = Le(e, t, r, a)).mode)
                                                    ? ((r.qc = de.zc.dir.node),
                                                      (r.sc = de.zc.dir.stream),
                                                      (r.rc = {}))
                                                    : 32768 == (61440 & r.mode)
                                                      ? ((r.qc = de.zc.file.node),
                                                        (r.sc = de.zc.file.stream),
                                                        (r.tc = 0),
                                                        (r.rc = null))
                                                      : 40960 == (61440 & r.mode)
                                                        ? ((r.qc = de.zc.link.node),
                                                          (r.sc = de.zc.link.stream))
                                                        : 8192 == (61440 & r.mode) &&
                                                          ((r.qc = de.zc.dd.node),
                                                          (r.sc = de.zc.dd.stream)),
                                        ...
                                        ed: function (e, t) {
                                            ...
                                            r >= t ||
                                                ((t = Math.max(
                                                    t,
                                                    (r * (1048576 > r ? 2 : 1.125)) >>> 0
                                                )),
                                                0 != r && (t = Math.max(t, 256)),
                                                (r = e.rc),
                                                (e.rc = new Uint8Array(t)),
                                                0 < e.tc &&
                                                    e.rc.set(r.subarray(0, e.tc), 0));
                                        },
                                        Gd: function (e, t) {
                                            if (e.tc != t)
                                        ...
                                        qc: {
                                                    ...
                                                    16384 == (61440 & e.mode)
                                                        ...
                                                        : 32768 == (61440 & e.mode)
                                                          ...
                                                          : 40960 == (61440 & e.mode)
                                                            ...
                                                            : (t.size = 0),
                                                    (t.pd = new Date(e.timestamp)),
                                                    (t.Dd = new Date(e.timestamp)),
                                                    (t.sd = new Date(e.timestamp)),
                                                    (t.qd = 4096),
                                                    (t.rd = Math.ceil(t.size / t.qd)),
                                                    t
                                                );
                                            },
                                            Ac: function (e, t) {
                                                (void 0 !== t.mode && (e.mode = t.mode),
                                                    ...
                                                    void 0 !== t.size && de.Gd(e, t.size));
                                            },
                                            Jc: function () {
                                                throw Ae[44];
                                            },
                                            Qc: function (e, t, r, a) {
                                                return de.createNode(e, t, r, a);
                                            },
                                            nd: function (e, t, r) {
                                            ...
                                            Rc: function (e) {
                                                var t,
                                                    r = ['.', '..'];
                                                for (t in e.rc)
                                                    e.rc.hasOwnProperty(t) && r.push(t);
                                                return r;
                                            },
                                            Sc: function (e, t, r) {
                                                return (
                                        ...
                                        sc: {
                                            read: function (e, t, r, a, n) {
                                                var i = e.node.rc;
                                                if (n >= e.node.tc) return 0;
                                                if (
                                                    8 < (e = Math.min(e.node.tc - n, a)) &&
                                                    i.subarray
                                                )
                                                    t.set(i.subarray(n, n + e), r);
                                                else
                                                    for (a = 0; a < e; a++)
                                                        t[r + a] = i[n + a];
                                                return e;
                                            },
                                            write: function (e, t, r, a, n, i) {
                                                if ((t.buffer === E.buffer && (i = !1), !a))
                                                    return 0;
                                                if (
                                                    (((e = e.node).timestamp = Date.now()),
                                                    t.subarray && (!e.rc || e.rc.subarray))
                                                ) {
                                                    if (i)
                                                        return (
                                                            (e.rc = t.subarray(r, r + a)),
                                                            (e.tc = a)
                                                        );
                                                    if (0 === e.tc && 0 === n)
                                                        return (
                                                ...
                                                if (
                                                    (de.ed(e, n + a),
                                                    e.rc.subarray && t.subarray)
                                                )
                                                    e.rc.set(t.subarray(r, r + a), n);
                                                else
                                                    for (i = 0; i < a; i++)
                                                        e.rc[n + i] = t[r + i];
                                                return ((e.tc = Math.max(e.tc, n + a)), a);
                                            },
                                            Ec: function (e, t, r) {
                                                if (
                                                    (1 === r
                                            ...
                                            jd: function (e, t, r, a, n, i) {
                                                ...
                                                if (
                                                    ...
                                                    E.set(e, r);
                                                } else ((a = !1), (r = e.byteOffset));
                                                return {Hc: r, Ud: a};
                                            },
                                            ld: function (e, t, r, a, n) {
                                                if (32768 != (61440 & e.node.mode))
                                                    throw new Ee(43);
                                                return (
                                                    2 & n || de.sc.write(e, t, 0, a, r, !1),
                                                    0
                                                );
                                            },
                                        },
                                ...
                                function xe(e, t) {
                                    for (var r = 0, a = 0; a < t.length; a++)
                                        r = ((r << 5) - r + t.charCodeAt(a)) | 0;
                                    return ((e + r) >>> 0) % we.length;
                                }
                                function ke(e, t) {
                                    var r;
                                    if ((r = (r = Me(e, 'x')) ? r : e.qc.Jc ? 0 : 2))
                                        throw new Ee(r, e);
                                    for (r = we[xe(e.id, t)]; r; r = r.Fc) {
                                        var a = r.name;
                                        if (r.parent.id === e.id && a === t) return r;
                                    }
                                    return e.qc.Jc(e, t);
                                }
                                function Le(e, t, r, a) {
                                ...
                                var Oe,
                                    Pe = {
                                        open: function (e) {
                                            ((e.sc = me[e.node.Lc].sc),
                                                e.sc.open && e.sc.open(e));
                                        },
                                        Ec: function () {
                                            throw new Ee(70);
                                        },
                                ...
                                function Be(e, t) {
                                    ...
                                    if (!r && !a) {
                                        var n = Te(t, {fd: !1});
                                        if (((t = n.path), (n = n.node).Kc))
                                            throw new Ee(10);
                                        if (16384 != (61440 & n.mode)) throw new Ee(54);
                                    }
                                    ((t = {type: e, be: {}, kd: t, Cd: []}),
                                        ((e = e.Bc(t)).Bc = t),
                                        (t.root = e),
                                        r
                                            ? (he = e)
                                            : n && ((n.Kc = t), n.Bc && n.Bc.Cd.push(t)));
                                }
                                function Ce(e, t, r) {
                                    var a = Te(e, {parent: !0}).node;
                                    if (!(e = se(e)) || '.' === e || '..' === e)
                                        throw new Ee(28);
                                    var n = Ie(a, e);
                                    if (n) throw new Ee(n);
                                    if (!a.qc.Qc) throw new Ee(63);
                                    return a.qc.Qc(a, e, t, r);
                                }
                                function De(e) {
                                    return Ce(e, 16895, 0);
                                }
                                ...
                                function Ne(e) {
                                    ...
                                    return _e(Re(e.parent), e.qc.Mc(e));
                                }
                                function Ge(e, t) {
                                    if (!(e = Te(e, {Pc: !t}).node)) throw new Ee(44);
                                ...
                                function He(e, r, a, n) {
                                    ...
                                    if (
                                        ...
                                        e = ie(e);
                                        try {
                                            o = Te(e, {Pc: !(131072 & r)}).node;
                                        } catch (e) {}
                                    }
                                    if (((i = !1), 64 & r))
                                        if (o) {
                                            if (128 & r) throw new Ee(20);
                                        } else ((o = Ce(e, a, 0)), (i = !0));
                                    ...
                                    if (512 & r) {
                                        if (
                                            ...
                                            throw new Ee(63);
                                        if (16384 == (61440 & a.mode)) throw new Ee(31);
                                        if (32768 != (61440 & a.mode)) throw new Ee(28);
                                        if ((i = Me(a, 'w'))) throw new Ee(i);
                                        a.qc.Ac(a, {size: 0, timestamp: Date.now()});
                                    }
                                    ((r &= -131713),
                                        (n = (function (e, t) {
                                ...
                                function $e(e, t, r) {
                                    ...
                                    return (
                                        ...
                                        (x[(r + 48) >> 2] = 4096),
                                        (x[(r + 52) >> 2] = a.rd),
                                        (x[(r + 56) >> 2] = (a.pd.getTime() / 1e3) | 0),
                                        (x[(r + 60) >> 2] = 0),
                                        (x[(r + 64) >> 2] = (a.Dd.getTime() / 1e3) | 0),
                                        (x[(r + 68) >> 2] = 0),
                                        (x[(r + 72) >> 2] = (a.sd.getTime() / 1e3) | 0),
                                        (x[(r + 76) >> 2] = 0),
                                        (J = [
                                            a.Zc >>> 0,
                                            ((K = a.Zc),
                                ...
                                var at,
                                    ...
                                    bt = [];
                                function gt(e, r, a, n) {
                                    if (r && t.Yc && e == t.canvas) return t.Yc;
                                    var i;
                                    if (r) {
                                        var o = {antialias: !1, alpha: !1, Bd: 1};
                                ...
                                function Ot(e, r, a) {
                                    ...
                                    if (
                                        (t.forcedAspectRatio &&
                                            ...
                                            (n / i < t.forcedAspectRatio
                                                ? (n = Math.round(i * t.forcedAspectRatio))
                                                : (i = Math.round(
                                                      n / t.forcedAspectRatio
                                                  ))),
                                ...
                                t._emscripten_is_main_browser_thread = Pt;
                                var St,
                                    Bt = [];
                                function Ct(e, t) {
                                    ((k[e >> 2] = t),
                                        (k[(e + 4) >> 2] = (t / 4294967296) | 0));
                                }
                                function Dt(e, t, r, a, n) {
                                    function i(t) {
                                        var r = 0,
                                            a = 0;
                                        (t &&
                                            ((a = y.response ? y.response.byteLength : 0),
                                            (r = _r(a)),
                                            A.set(new Uint8Array(y.response), r)),
                                            (k[(e + 12) >> 2] = r),
                                            Ct(e + 16, a));
                                    }
                                    var o = k[(e + 8) >> 2];
                                    if (o) {
                                        ...
                                        (Bt.push(y),
                                            (k[(e + 0) >> 2] = Bt.length),
                                            (o = m && _ ? A.slice(m, m + _) : null),
                                            (y.onload = function (a) {
                                                i(b && !g);
                                                var n = y.response
                                                    ? y.response.byteLength
                                                    : 0;
                                                (Ct(e + 24, 0),
                                                    n && Ct(e + 32, n),
                                                    (R[(e + 40) >> 1] = y.readyState),
                                                    (R[(e + 42) >> 1] = y.status),
                                                    y.statusText &&
                                                        O(y.statusText, A, e + 44, 64),
                                            ...
                                            (y.onprogress = function (t) {
                                                ...
                                                (b &&
                                                    g &&
                                                    ((n = _r(r)),
                                                    A.set(new Uint8Array(y.response), n)),
                                                    (k[(e + 12) >> 2] = n),
                                                    Ct(e + 16, r),
                                                    Ct(e + 24, t.loaded - r),
                                                    Ct(e + 32, t.total),
                                ...
                                function Ut(e, t, r, a) {
                                    ...
                                    } else a(e, 0, 'IndexedDB not available!');
                                }
                                var Vt,
                                    Nt = {};
                                function Gt() {
                                ...
                                (Object.defineProperties(ar.prototype, {
                                                    ...
                                                    : (e.parentNode.insertBefore(n, e),
                                                      ...
                                                      vt
                                                          ? ('undefined' != typeof SDL &&
                                                            ...
                                                            It())
                                                          : Ot(n)),
                                                    t.onFullScreen && t.onFullScreen(ht),
                                                    t.onFullscreen && t.onFullscreen(ht));
                                            }
                                            (void 0 === (yt = e) && (yt = !0),
                                                void 0 === (vt = r) && (vt = !1));
                                    ...
                                    (t.setCanvasSize = function (e, r, a) {
                                        (Ot(t.canvas, e, r), a || It());
                                    }),
                                    ...
                                    (t.createContext = function (e, t, r, a) {
                                        return gt(e, t, r, a);
                                    }),
                                    (function (e, t) {
                                        try {
                                ...
                                var ir = {
                                        ...
                                        E: function (e, t, r) {
                                            try {
                                                var a = tt(e);
                                                if (!a.Dc) {
                                                    var n = Te(a.path, {Pc: !0}).node;
                                                    if (!n.qc.Rc) throw new Ee(54);
                                                    var i = n.qc.Rc(n);
                                                    a.Dc = i;
                                                }
                                                e = 0;
                                        ...
                                        K: function (e) {
                                            try {
                                                ...
                                                return (
                                                    B('Emscripten', e + t.sysname),
                                                    B('emscripten', e + t.nodename),
                                                    B('1.0', e + t.release),
                                                    B('#1', e + t.version),
                                                    B('wasm32', e + t.machine),
                                                    0
                                                );
                                            } catch (e) {
                                                return (
                                        ...
                                        w: function (e) {
                                            ...
                                            for (var r = 1; 4 >= r; r *= 2) {
                                                ...
                                                ((a = Math.min(a, e + 100663296)),
                                                    0 < (a = Math.max(e, a)) % 65536 &&
                                                        (a += 65536 - (a % 65536)));
                                                e: {
                                                    try {
                                                        (m.grow(
                                                            (Math.min(2147483648, a) -
                                                                v.byteLength +
                                                                65535) >>>
                                                                16
                                                        ),
                                        ...
                                        M: function (e, t, r, a, n) {
                                            ...
                                            var f = e + 112,
                                                ...
                                                b = !!(4 & m),
                                                g = !!(32 & m);
                                            if (((m = !!(16 & m)), 'EM_IDB_STORE' === u))
                                                ((u = k[(f + 84) >> 2]),
                                                    Ut(
                                                        e,
                                                        A.slice(u, u + k[(f + 88) >> 2]),
                                                        c,
                                                        s
                                                    ));
                                            else if ('EM_IDB_DELETE' === u)
                                                !(function (e, t, r) {
                                                    var a = St;
                                                    if (a) {
                                                        var n = k[(e + 112 + 64) >> 2];
                                            ...
                                            try {
                                                e: {
                                                    for (
                                                        ...
                                                        if (1 == (2097155 & s.flags))
                                                            throw new Ee(8);
                                                        if (16384 == (61440 & s.node.mode))
                                                            throw new Ee(31);
                                        ...
                                        m: function (e, t) {
                                            Qt.bindTexture(e, Ht[t]);
                                        },
                                        o: function (e, t) {
                                            for (var r = 0; r < e; r++) {
                                                var a = Qt.createTexture(),
                                                    n = a && Yt(Ht);
                                                (a
                                                    ? ((a.name = n), (Ht[n] = a))
                                                    : Xt || (Xt = 1282),
                                                        ...
                                                        : 4 == u
                                                          ...
                                                          : 6 == u
                                                            ...
                                                            : 5 == u || 28922 == u
                                                              ...
                                                              : R;
                                                var l =
                                                    31 - Math.clz32(u.BYTES_PER_ELEMENT);
                                                _ = u.subarray(
                                                    _ >> l,
                                                    (_ +
                                                        n *
                                        ...
                                        q: function (e, t) {
                                            (!(function () {
                                                ...
                                                (e = new Date(1e3 * x[e >> 2])),
                                                (x[t >> 2] = e.getSeconds()),
                                                (x[(t + 4) >> 2] = e.getMinutes()),
                                                (x[(t + 8) >> 2] = e.getHours()),
                                                (x[(t + 12) >> 2] = e.getDate()),
                                                (x[(t + 16) >> 2] = e.getMonth()),
                                                (x[(t + 20) >> 2] = e.getFullYear() - 1900),
                                                (x[(t + 24) >> 2] = e.getDay()));
                                            var r = new Date(e.getFullYear(), 0, 1);
                                            ((x[(t + 28) >> 2] =
                                                ((e.getTime() - r.getTime()) / 864e5) | 0),
                                                (x[(t + 36) >> 2] =
                                                    -60 * e.getTimezoneOffset()));
                                            var a = new Date(
                                                e.getFullYear(),
                                                6,
                                                1
                                        ...
                                        z: function (e, t, r, a) {
                                            return (function (e, t, r, a) {
                                                ...
                                                (c = {
                                                    ...
                                                    r = r.replace(new RegExp(f, 'g'), c[f]);
                                                var u =
                                                ...
                                                return (f = nr(r, !1)).length > t
                                                    ? 0
                                                    : (E.set(f, e), f.length - 1);
                                            })(e, t, r, a);
                                        },
                                        d: function (e) {
                                    ...
                                    or = (function () {
                                        ...
                                        var r = {a: ir};
                                        if ((X(), t.instantiateWasm))
                                            try {
                                                return t.instantiateWasm(r, e);
                                            } catch (e) {
                                                return (
                                                    d(
                                        ...
                                        return (
                                            (r = (function (e) {
                                                ...
                                                try {
                                                    ...
                                                    var a = new WebAssembly.Module(r),
                                                        n = new WebAssembly.Instance(a, e);
                                                } catch (t) {
                                                    throw (
                                                        (e = t.toString()),
                                                        d(
                                ...
                                ((t.___wasm_call_ctors = or.T),
                                    (t._zappar_has_initialized = or.U),
                                    (t._zappar_invert = or.V),
                                    (t._zappar_loaded = or.W),
                                    (t._zappar_pipeline_create = or.Y),
                                    (t._zappar_pipeline_destroy = or.Z),
                                    (t._zappar_pipeline_camera_frame_submit = or._),
                                    (t._zappar_pipeline_camera_frame_submit_raw_pointer =
                                        or.$),
                                    (t._zappar_pipeline_frame_update = or.aa),
                                    (t._zappar_pipeline_camera_frame_user_data = or.ba),
                                    (t._zappar_pipeline_camera_model = or.ca),
                                    (t._zappar_pipeline_frame_number = or.da),
                                    (t._zappar_pipeline_motion_accelerometer_submit =
                                        or.ea),
                                    (t._zappar_pipeline_motion_rotation_rate_submit =
                                        or.fa),
                                    (t._zappar_pipeline_motion_attitude_submit = or.ga),
                                    (t._zappar_pipeline_motion_attitude_matrix_submit =
                                        or.ha),
                                    (t._zappar_pipeline_camera_frame_user_facing = or.ia),
                                    (t._zappar_pipeline_camera_frame_texture_matrix =
                                        or.ja),
                                    (t._zappar_pipeline_camera_pose_with_attitude = or.ka),
                                    (t._zappar_pipeline_camera_pose_with_origin = or.la),
                                    (t._zappar_pipeline_camera_frame_camera_attitude =
                                        or.ma),
                                    (t._zappar_pipeline_camera_frame_device_attitude =
                                        or.na),
                                    (t._zappar_pipeline_camera_frame_texture_gl = or.oa),
                                    (t._zappar_pipeline_camera_frame_upload_gl = or.pa),
                                    (t._zappar_pipeline_sequence_record_start = or.qa),
                                    (t._zappar_pipeline_sequence_record_stop = or.ra),
                                    (t._zappar_pipeline_sequence_record_clear = or.sa),
                                    (t._zappar_pipeline_sequence_record_device_attitude_matrices_set =
                                        or.ta),
                                    (t._zappar_pipeline_sequence_record_data_size = or.ua),
                                    (t._zappar_pipeline_sequence_record_data = or.va),
                                    (t._zappar_pipeline_process_gl = or.wa),
                                    (t._zappar_pipeline_camera_pose_default = or.xa),
                                    (t._zappar_instant_world_tracker_create = or.ya),
                                    (t._zappar_instant_world_tracker_destroy = or.za),
                                    (t._zappar_instant_world_tracker_anchor_pose_set_from_camera_offset_raw =
                                        or.Aa),
                                    (t._zappar_instant_world_tracker_anchor_pose_raw =
                                        or.Ba),
                                    (t._zappar_instant_world_tracker_enabled_set = or.Ca),
                                    (t._zappar_instant_world_tracker_enabled = or.Da),
                                    (t._zappar_image_tracker_create = or.Ea),
                                    (t._zappar_image_tracker_destroy = or.Fa),
                                    ...
                                    (t.__Z42zappar_image_tracker_target_load_from_fileP23zappar_image_tracker_tiPKc =
                                        or.Ha));
                                var sr = (t._free = or.Ia);
                                ((t._zappar_image_tracker_anchor_count = or.Ja),
                                    (t._zappar_image_tracker_anchor_id = or.Ka),
                                    (t._zappar_image_tracker_anchor_pose_raw = or.La),
                                    (t._zappar_image_tracker_enabled_set = or.Ma),
                                    (t._zappar_image_tracker_enabled = or.Na),
                                    (t._zappar_image_tracker_target_loaded_version = or.Oa),
                                    (t.__Z33zappar_image_tracker_target_countP23zappar_image_tracker_ti =
                                        or.Pa),
                                    ...
                                    (t.__Z47zappar_image_tracker_target_preview_rgba_heightP23zappar_image_tracker_tii =
                                        or.Wa),
                                    (t.__Z38zappar_image_tracker_target_radius_topP23zappar_image_tracker_tii =
                                        or.Xa),
                                    (t.__Z41zappar_image_tracker_target_radius_bottomP23zappar_image_tracker_tii =
                                        or.Ya),
                                    (t.__Z39zappar_image_tracker_target_side_lengthP23zappar_image_tracker_tii =
                                        or.Za),
                                    (t.__Z49zappar_image_tracker_target_physical_scale_factorP23zappar_image_tracker_tii =
                                        or._a),
                                    (t.__Z49zappar_image_tracker_target_preview_mesh_verticesP23zappar_image_tracker_tii =
                                        or.$a),
                                    (t.__Z48zappar_image_tracker_target_preview_mesh_normalsP23zappar_image_tracker_tii =
                                        or.ab),
                                    (t.__Z44zappar_image_tracker_target_preview_mesh_uvsP23zappar_image_tracker_tii =
                                        or.bb),
                                    (t.__Z48zappar_image_tracker_target_preview_mesh_indicesP23zappar_image_tracker_tii =
                                        or.cb),
                                    (t.__Z54zappar_image_tracker_target_preview_mesh_vertices_sizeP23zappar_image_tracker_tii =
                                        or.db),
                                    (t.__Z53zappar_image_tracker_target_preview_mesh_normals_sizeP23zappar_image_tracker_tii =
                                        or.eb),
                                    (t.__Z49zappar_image_tracker_target_preview_mesh_uvs_sizeP23zappar_image_tracker_tii =
                                        or.fb),
                                    (t.__Z53zappar_image_tracker_target_preview_mesh_indices_sizeP23zappar_image_tracker_tii =
                                        or.gb),
                                    (t.__Z32zappar_image_tracker_target_typeP23zappar_image_tracker_tii =
                                        or.hb),
                                    (t._zappar_face_tracker_create = or.ib),
                                    (t._zappar_face_tracker_destroy = or.jb),
                                    (t._zappar_face_tracker_model_load_from_memory = or.kb),
                                    (t._zappar_face_tracker_anchor_count = or.lb),
                                    (t._zappar_face_tracker_anchor_id = or.mb),
                                    (t._zappar_face_tracker_anchor_pose_raw = or.nb),
                                    (t._zappar_face_tracker_anchor_identity_coefficients =
                                        or.ob),
                                    (t._zappar_face_tracker_anchor_expression_coefficients =
                                        or.pb),
                                    (t._zappar_face_tracker_enabled_set = or.qb),
                                    (t._zappar_face_tracker_enabled = or.rb),
                                    (t._zappar_face_tracker_max_faces_set = or.sb),
                                    (t._zappar_face_tracker_max_faces = or.tb),
                                    (t._zappar_face_tracker_model_loaded_version = or.ub),
                                    (t._zappar_face_landmark_create = or.vb),
                                    (t._zappar_face_landmark_destroy = or.wb),
                                    (t.__Z27zappar_face_landmark_updateP23zappar_face_landmark_tiPKfS2_i =
                                        or.xb),
                                    (t._zappar_face_landmark_anchor_pose = or.yb),
                                    (t._zappar_barcode_finder_create = or.zb),
                                    (t._zappar_barcode_finder_destroy = or.Ab),
                                    (t._zappar_barcode_finder_found_number = or.Bb),
                                    (t._zappar_barcode_finder_found_text = or.Cb),
                                    (t._zappar_barcode_finder_enabled_set = or.Db),
                                    (t._zappar_barcode_finder_enabled = or.Eb),
                                    (t._zappar_barcode_finder_found_format = or.Fb),
                                    (t._zappar_barcode_finder_formats = or.Gb),
                                    (t._zappar_barcode_finder_formats_set = or.Hb));
                                var _r = (t._malloc = or.Ib);
                                ((t._zappar_face_mesh_create = or.Jb),
                                    (t._zappar_face_mesh_destroy = or.Kb),
                                    ...
                                    (t.__Z25zappar_face_mesh_verticesP19zappar_face_mesh_ti =
                                        or.Qb),
                                    (t.__Z20zappar_face_mesh_uvsP19zappar_face_mesh_ti =
                                        or.Rb),
                                    ...
                                    (t.__Z24zappar_face_mesh_normalsP19zappar_face_mesh_ti =
                                        or.Vb),
                                    (t._zappar_camera_source_create = or.Wb),
                                    (t._zappar_camera_source_destroy = or.Xb),
                                    (t._zappar_camera_source_start = or.Yb),
                                    (t._zappar_camera_source_pause = or.Zb),
                                    (t._zappar_camera_default_device_id = or._b),
                                    (t._zappar_sequence_source_create = or.$b),
                                    (t.__Z28zappar_sequence_source_startP25zappar_sequence_source_ti =
                                        or.ac),
                                    (t.__Z39zappar_sequence_source_load_from_memoryP25zappar_sequence_source_tiPKci =
                                        or.bc),
                                    (t.__Z28zappar_sequence_source_pauseP25zappar_sequence_source_ti =
                                        or.cc),
                                    (t._zappar_sequence_source_destroy = or.dc),
                                    (t._zappar_sequence_source_max_playback_fps_set =
                                        or.ec),
                                    (t._zappar_log_level_set = or.fc),
                                    (t._zappar_log_level = or.gc),
                                    (t.__Z23zappar_log_redirect_setPFv18zappar_log_level_tPKcE =
                                        or.hc),
                                    (t._zappar_analytics_project_id_set = or.ic));
                                var cr,
                                    fr = (t.___errno_location = or.jc),
                                    ur = (t.__get_tzname = or.kc),
                                    lr = (t.__get_daylight = or.lc),
                                    pr = (t.__get_timezone = or.mc),
                                    dr = (t.stackSave = or.nc),
                                    hr = (t.stackRestore = or.oc),
                                    mr = (t.stackAlloc = or.pc);
                                function br(e) {
                                        ...
                                        if (!cr && ((cr = !0), (t.calledRun = !0), !g)) {
                                            if (
                                                (t.noFSInit ||
                                                    ...
                                                    t.stdin
                                                        ? Xe('stdin', t.stdin)
                                                        : Ve('/dev/tty', '/dev/stdin'),
                                                    t.stdout
                                                        ? Xe('stdout', null, t.stdout)
                                                        : Ve('/dev/tty', '/dev/stdout'),
                                                    t.stderr
                                                        ? Xe('stderr', null, t.stderr)
                                                        : Ve('/dev/tty1', '/dev/stderr'),
                                                    He('/dev/stdin', 0),
                                                    He('/dev/stdout', 1),
                                                    He('/dev/stderr', 1)),
                                                te(V),
                                ...
                                function wr(e) {
                                    ((b = e),
                                        h || (t.onExit && t.onExit(e), (g = !0)),
                                        _(e, new br(e)));
                                }
                                if (
                                    ((t.cwrap = function (e, t, r, a) {
                    ...
                    class _ {
                                ...
                                this._deserializer.forMessages((e, t) => {
                                    switch (e) {
                                        case 34:
                                            ...
                                            break;
                                        case 31:
                                            this._impl.analytics_project_id_set(
                                                t.string(),
                                                t.string()
                                            );
                                            break;
                                        ...
                                        case 13: {
                                            let e = t.type(),
                                                r = this._pipeline_by_instance.get(e);
                                            if (void 0 === r) return;
                                            this._impl.pipeline_motion_attitude_matrix_submit(
                                                r,
                                                t.matrix4x4()
                                            );
                                            break;
                                        ...
                                        case 29: {
                                            let e = t.type(),
                                                r = t.type(),
                                                a = this._pipeline_by_instance.get(r),
                                                n = t.string(),
                                                i = this._impl.camera_source_create(a, n);
                                            (this._camera_source_by_instance.set(e, i),
                                                this._pipeline_id_by_camera_source_id.set(
                                                    e,
                                                    r
                                                ));
                                            break;
                                        ...
                                        case 35: {
                                            let e = t.type(),
                                                r = t.type(),
                                                a = this._pipeline_by_instance.get(r),
                                                n = this._impl.sequence_source_create(a);
                                            (this._sequence_source_by_instance.set(e, n),
                                                this._pipeline_id_by_sequence_source_id.set(
                                                    e,
                                                    r
                                                ));
                                            break;
                                        ...
                                        case 36: {
                                            let e = t.type(),
                                                r =
                                                    this._sequence_source_by_instance.get(
                                                        e
                                                    );
                                            if (void 0 === r) return;
                                            (this._impl.sequence_source_destroy(r),
                                                this._sequence_source_by_instance.delete(
                                                    e
                                                ));
                                            break;
                                        }
                                        case 2: {
                                            let e = t.type(),
                                                r = t.type(),
                                                a = this._pipeline_by_instance.get(r),
                                                n = this._impl.image_tracker_create(a);
                                            (this._image_tracker_by_instance.set(e, n),
                                                this._pipeline_id_by_image_tracker_id.set(
                                                    e,
                                                    r
                                                ));
                                            break;
                                        ...
                                        case 3: {
                                            let e = t.type(),
                                                r = this._image_tracker_by_instance.get(e);
                                            if (void 0 === r) return;
                                            this._impl.image_tracker_enabled_set(
                                                r,
                                                t.bool()
                                            );
                                            break;
                                        ...
                                        case 20: {
                                            let e = t.type(),
                                                r = t.type(),
                                                a = this._pipeline_by_instance.get(r),
                                                n = this._impl.face_tracker_create(a);
                                            (this._face_tracker_by_instance.set(e, n),
                                                this._pipeline_id_by_face_tracker_id.set(
                                                    e,
                                                    r
                                                ));
                                            break;
                                        ...
                                        case 24: {
                                            let e = t.type(),
                                                r = this._face_tracker_by_instance.get(e);
                                            if (void 0 === r) return;
                                            this._impl.face_tracker_max_faces_set(
                                                r,
                                                t.int()
                                            );
                                            break;
                                        ...
                                        case 32: {
                                            let e = t.type(),
                                                ...
                                                a = this._impl.face_landmark_create(r);
                                        ...
                                        case 16: {
                                            let e = t.type(),
                                                r = t.type(),
                                                a = this._pipeline_by_instance.get(r),
                                                n = this._impl.barcode_finder_create(a);
                                            (this._barcode_finder_by_instance.set(e, n),
                                                this._pipeline_id_by_barcode_finder_id.set(
                                                    e,
                                                    r
                                                ));
                                            break;
                                        ...
                                        case 18: {
                                            let e = t.type(),
                                                r = this._barcode_finder_by_instance.get(e);
                                            if (void 0 === r) return;
                                            this._impl.barcode_finder_enabled_set(
                                                r,
                                                t.bool()
                                            );
                                            break;
                                        ...
                                        case 19: {
                                            let e = t.type(),
                                                r = this._barcode_finder_by_instance.get(e);
                                            if (void 0 === r) return;
                                            this._impl.barcode_finder_formats_set(
                                                r,
                                                t.barcodeFormat()
                                            );
                                            break;
                                        ...
                                        case 5: {
                                            let e = t.type(),
                                                ...
                                                a = this._pipeline_by_instance.get(r),
                                                n =
                                                    this._impl.instant_world_tracker_create(
                                                        a
                                                    );
                                            (this._instant_world_tracker_by_instance.set(
                                                e,
                                                n
                                            ),
                                                this._pipeline_id_by_instant_world_tracker_id.set(
                                                    e,
                                                    r
                                                ));
                                            break;
                                        ...
                                        case 15: {
                                            let e = t.type(),
                                                r =
                                                    this._instant_world_tracker_by_instance.get(
                                                        e
                                                    );
                                            if (void 0 === r) return;
                                            (this._impl.instant_world_tracker_destroy(r),
                                                this._instant_world_tracker_by_instance.delete(
                                                    e
                                                ));
                                            break;
                                        }
                                        ...
                                        case 7: {
                                            ...
                                            if (void 0 === r) return;
                                            this._impl.instant_world_tracker_anchor_pose_set_from_camera_offset_raw(
                                                r,
                                                t.float(),
                                                t.float(),
                                                t.float(),
                        ...
                        exploreState() {
                            for (let [e, t] of this._pipeline_by_instance) {
                                ...
                                if (!r) continue;
                                let a = this.serializersByPipelineId.get(r);
                                a &&
                                    (a.sendMessage(7, (r) => {
                                        (r.type(e),
                                            r.int(this._impl.pipeline_frame_number(t)));
                                    }),
                                    a.sendMessage(6, (r) => {
                                        (r.type(e),
                                            r.cameraModel(
                                                this._impl.pipeline_camera_model(t)
                                            ));
                                    }),
                                    a.sendMessage(5, (r) => {
                                        (r.type(e),
                                            r.int(
                                                this._impl.pipeline_camera_frame_user_data(
                                                    t
                                                )
                                            ));
                                    }),
                                    ...
                                    a.sendMessage(12, (r) => {
                                        (r.type(e),
                                            r.matrix4x4(
                                                this._impl.pipeline_camera_frame_device_attitude(
                                                    t
                                                )
                                            ));
                                    }));
                            ...
                            for (let [e, t] of this._image_tracker_by_instance) {
                                ...
                                if (a) {
                                    (a.sendMessage(19, (r) => {
                                        (r.type(e),
                                            r.int(
                                                this._impl.image_tracker_target_loaded_version(
                                                    t
                                                )
                                            ));
                                    }),
                                        a.sendMessage(1, (r) => {
                                            (r.type(e),
                                                r.int(
                                                    this._impl.image_tracker_anchor_count(t)
                                                ));
                                        }));
                                    for (
                                        let r = 0;
                                        ...
                                        a.sendMessage(2, (a) => {
                                            (a.type(e),
                                                a.int(r),
                                                a.string(
                                                    this._impl.image_tracker_anchor_id(t, r)
                                                ));
                                        });
                                    for (
                                        let r = 0;
                            ...
                            for (let [e, t] of this._face_tracker_by_instance) {
                                ...
                                if (a) {
                                    (a.sendMessage(18, (r) => {
                                        (r.type(e),
                                            r.int(
                                                this._impl.face_tracker_model_loaded_version(
                                                    t
                                                )
                                            ));
                                    }),
                                        a.sendMessage(13, (r) => {
                                            (r.type(e),
                                                r.int(
                                                    this._impl.face_tracker_anchor_count(t)
                                                ));
                                        }));
                                    for (
                                        let r = 0;
                                        ...
                                        a.sendMessage(14, (a) => {
                                            (a.type(e),
                                                a.int(r),
                                                a.string(
                                                    this._impl.face_tracker_anchor_id(t, r)
                                                ));
                                        });
                                    for (
                                        let r = 0;
                            ...
                            for (let [e, t] of this._barcode_finder_by_instance) {
                                ...
                                if (a) {
                                    a.sendMessage(8, (r) => {
                                        (r.type(e),
                                            r.int(
                                                this._impl.barcode_finder_found_number(t)
                                            ));
                                    });
                                    for (
                                        let r = 0;
                                        ...
                                        a.sendMessage(9, (a) => {
                                            (a.type(e),
                                                a.int(r),
                                                a.string(
                                                    this._impl.barcode_finder_found_text(
                                                        t,
                                                        r
                                                    )
                                                ));
                            ...
                            for (let [e, t] of this._instant_world_tracker_by_instance) {
                                let r =
                                    this._pipeline_id_by_instant_world_tracker_id.get(e);
                                if (!r) continue;
                                let a = this.serializersByPipelineId.get(r);
                                a &&
                                    a.sendMessage(4, (r) => {
                    ...
                    (!(function (e) {
                        ...
                        (function (e) {
                            ((e[(e.FRAME_PIXEL_FORMAT_I420 = 0)] =
                                'FRAME_PIXEL_FORMAT_I420'),
                                (e[(e.FRAME_PIXEL_FORMAT_I420A = 1)] =
                                    'FRAME_PIXEL_FORMAT_I420A'),
                                (e[(e.FRAME_PIXEL_FORMAT_I422 = 2)] =
                                    'FRAME_PIXEL_FORMAT_I422'),
                                (e[(e.FRAME_PIXEL_FORMAT_I444 = 3)] =
                                    'FRAME_PIXEL_FORMAT_I444'),
                                (e[(e.FRAME_PIXEL_FORMAT_NV12 = 4)] =
                                    'FRAME_PIXEL_FORMAT_NV12'),
                                (e[(e.FRAME_PIXEL_FORMAT_RGBA = 5)] =
                                    'FRAME_PIXEL_FORMAT_RGBA'),
                                (e[(e.FRAME_PIXEL_FORMAT_BGRA = 6)] =
                                    'FRAME_PIXEL_FORMAT_BGRA'),
                    ...
                    class w {
                        constructor(e) {
                            ((this._gl = e),
                                ...
                                this._viewports.push(
                                    this._gl.getParameter(this._gl.VIEWPORT)
                                ),
                                (this._gl.viewport = (e, t, r, a) => {
                        ...
                        static get(e) {
                            let t = g.get(e);
                            return (t || ((t = new w(e)), g.set(e, t)), t);
                        }
                        push() {
                            this._viewports.push(
                                this._viewports[this._viewports.length - 1]
                    ...
                    'undefined' != typeof window &&
                        ...
                        window.location.href.indexOf('_mstppipeline') >= 0 &&
                            (console.log(
                                'Configuring for MSTP camera pipeline (if supported)'
                            ),
                            (E.preferMediaStreamTrackProcessorCamera = !0)),
                        window.location.href.indexOf('_imagebitmappipeline') >= 0 &&
                            (console.log(
                                'Configuring for ImageBitmap camera pipeline (if supported)'
                            ),
                            (E.preferImageBitmapCamera = !0)));
                    let A = new v.UAParser(),
                        T = (A.getOS().name || 'unknown').toLowerCase(),
                        R = (A.getEngine().name || 'unknown').toLowerCase();
                    function x(e) {
                        E.forceWindowOrientation = !0;
                        let t = e.split('.');
                        if (t.length >= 2) {
                            const e = parseInt(t[0]),
                                r = parseInt(t[1]);
                            ((e < 11 || (11 === e && r < 3)) && (E.blacklisted = !0),
                                (e < 12 || (12 === e && r < 2)) &&
                                    (E.videoElementInDOM = !0),
                                ((12 === e && r >= 2) || e >= 13) &&
                                    (E.showGyroPermissionsWarningIfNecessary = !0),
                                e >= 13 && (E.showSafariPermissionsResetIfNecessary = !0),
                                ((e >= 12 && r > 1) || e >= 13) &&
                                    navigator.mediaDevices &&
                                    navigator.mediaDevices.getSupportedConstraints &&
                                    navigator.mediaDevices.getSupportedConstraints()
                                        .frameRate &&
                                    ((E.requestHighFrameRate = !0),
                                    e < 14 &&
                                        ((E.videoHeight = 360), (E.dataHeight = 180))),
                                16 === e && r >= 4 && (E.ios164CameraSelection = !0),
                                e >= 17 && (E.relyOnConstraintsForCameraSelection = !0));
                        }
                    }
                    function k(e, t, r) {
                        ...
                        if (n && n.trim().length > 0)
                            throw new Error('Shader compile error: ' + n);
                        return a;
                    }
                    ('webkit' === R &&
                        'ios' !== T &&
                        ((E.deviceMotionMutliplier = 1),
                        'undefined' != typeof window &&
                    ...
                    class L {
                        ...
                        uploadFrame(e, t, r, a) {
                            ...
                            const i = w.get(n);
                            i.push();
                            const o = n.isEnabled(n.SCISSOR_TEST),
                                s = n.isEnabled(n.DEPTH_TEST),
                                _ = n.isEnabled(n.BLEND),
                                c = n.isEnabled(n.CULL_FACE),
                                f = n.isEnabled(n.STENCIL_TEST),
                                u = n.getParameter(n.ACTIVE_TEXTURE),
                                l = n.getParameter(n.UNPACK_FLIP_Y_WEBGL),
                                p = n.getParameter(n.CURRENT_PROGRAM);
                            n.activeTexture(n.TEXTURE0);
                            const d = n.getParameter(n.TEXTURE_BINDING_2D),
                                h = n.getParameter(n.FRAMEBUFFER_BINDING),
                                m = n.getParameter(n.ARRAY_BUFFER_BINDING),
                                b = n.getParameter(n.ELEMENT_ARRAY_BUFFER_BINDING);
                            ...
                            const g = n.RGBA,
                                y = n.RGBA,
                                v = n.UNSIGNED_BYTE;
                            n.texImage2D(n.TEXTURE_2D, 0, g, y, v, t);
                            let A = 0,
                                T = 0;
                            ('undefined' != typeof HTMLVideoElement &&
                            t instanceof HTMLVideoElement
                                ? ((A = t.videoWidth), (T = t.videoHeight))
                                : ((A = t.width), (T = t.height)),
                                T > A && (T = [A, (A = T)][0]),
                                this._updateTransforms(r, a));
                            let R = this._getFramebuffer(n, E.dataWidth / 4, E.dataHeight),
                                x = this._getVertexBuffer(n),
                                k = this._getIndexBuffer(n),
                                L = this._getGreyscaleShader(n);
                            const F = n.getVertexAttrib(
                                    L.aVertexPositionLoc,
                                    n.VERTEX_ATTRIB_ARRAY_SIZE
                                ),
                                z = n.getVertexAttrib(
                                    L.aVertexPositionLoc,
                                    n.VERTEX_ATTRIB_ARRAY_TYPE
                                ),
                                M = n.getVertexAttrib(
                                    L.aVertexPositionLoc,
                                ...
                                I = n.getVertexAttrib(
                                    L.aVertexPositionLoc,
                                    n.VERTEX_ATTRIB_ARRAY_STRIDE
                                ),
                                O = n.getVertexAttribOffset(
                                    L.aVertexPositionLoc,
                                    n.VERTEX_ATTRIB_ARRAY_POINTER
                                ),
                                P = n.getVertexAttrib(
                                    L.aVertexPositionLoc,
                                    n.VERTEX_ATTRIB_ARRAY_ENABLED
                                ),
                                S = n.getVertexAttrib(
                                    L.aVertexPositionLoc,
                                    n.VERTEX_ATTRIB_ARRAY_BUFFER_BINDING
                                ),
                                B = n.getVertexAttrib(
                                    L.aTextureCoordLoc,
                                    n.VERTEX_ATTRIB_ARRAY_SIZE
                            ...
                            (this._isWebGL2
                                ? ((W = n.getVertexAttrib(
                                      L.aVertexPositionLoc,
                                      n.VERTEX_ATTRIB_ARRAY_DIVISOR
                                  )),
                                  (H = n.getVertexAttrib(
                                      L.aTextureCoordLoc,
                                      n.VERTEX_ATTRIB_ARRAY_DIVISOR
                                  )),
                                  n.vertexAttribDivisor(L.aVertexPositionLoc, 0),
                                  n.vertexAttribDivisor(L.aTextureCoordLoc, 0))
                                ...
                                n.enableVertexAttribArray(L.aVertexPositionLoc),
                                n.vertexAttribPointer(
                                    L.aTextureCoordLoc,
                                    2,
                                    n.FLOAT,
                                ...
                                n.enableVertexAttribArray(L.aTextureCoordLoc),
                                n.bindBuffer(n.ELEMENT_ARRAY_BUFFER, k),
                                n.useProgram(L.program),
                                n.uniform1f(L.uTexWidthLoc, E.dataWidth),
                                n.uniformMatrix4fv(
                                    L.uUvTransformLoc,
                                    !1,
                                ...
                                n.activeTexture(n.TEXTURE0),
                                n.bindTexture(n.TEXTURE_2D, e),
                                n.uniform1i(L.uSamplerLoc, 0),
                                n.drawElements(n.TRIANGLES, 6, n.UNSIGNED_SHORT, 0),
                                n.bindBuffer(n.ARRAY_BUFFER, S),
                                n.vertexAttribPointer(L.aVertexPositionLoc, F, z, M, I, O),
                                n.bindBuffer(n.ARRAY_BUFFER, N),
                                n.vertexAttribPointer(L.aTextureCoordLoc, B, C, D, U, V),
                                n.bindBuffer(n.ARRAY_BUFFER, m),
                                n.bindBuffer(n.ELEMENT_ARRAY_BUFFER, b),
                                P || n.disableVertexAttribArray(L.aVertexPositionLoc),
                                G || n.disableVertexAttribArray(L.aTextureCoordLoc),
                                this._isWebGL2
                                    ? (n.vertexAttribDivisor(L.aVertexPositionLoc, W),
                                      n.vertexAttribDivisor(L.aTextureCoordLoc, H))
                                    : this._instancedArraysExtension &&
                                      (this._instancedArraysExtension.vertexAttribDivisorANGLE(
                                          L.aVertexPositionLoc,
                                          W
                                ...
                                n.activeTexture(u),
                                n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, l),
                                i.pop(),
                                _ && n.enable(n.BLEND),
                                c && n.enable(n.CULL_FACE),
                                s && n.enable(n.DEPTH_TEST),
                                o && n.enable(n.SCISSOR_TEST),
                                f && n.enable(n.STENCIL_TEST));
                        }
                        readFrame(e, t) {
                            let r = this._gl,
                                a = new Uint8Array(t);
                            const n = r.getParameter(r.FRAMEBUFFER_BINDING);
                            let i = this._getFramebuffer(r, E.dataWidth / 4, E.dataHeight);
                            return (
                                ...
                                r.bindFramebuffer(r.FRAMEBUFFER, n),
                                {
                                    ...
                                    data: t,
                                    texture: e,
                                    dataWidth: E.dataWidth,
                                    dataHeight: E.dataHeight,
                        ...
                        _getFramebuffer(e, t, r) {
                            ...
                            if (n !== e.FRAMEBUFFER_COMPLETE)
                                throw new Error(
                                    'Framebuffer not complete: ' + n.toString()
                                );
                            return (
                                (this._framebufferWidth = t),
                                (this._framebufferHeight = r),
                        ...
                        _getGreyscaleShader(e) {
                            ...
                            let r = k(e, e.VERTEX_SHADER, O),
                                a = k(e, e.FRAGMENT_SHADER, P);
                            (e.attachShader(t, r),
                                e.attachShader(t, a),
                                (function (e, t) {
                                    e.linkProgram(t);
                            ...
                            let n = e.getUniformLocation(t, 'uTexWidth');
                            if (!n)
                    ...
                    let B = new (class {
                            constructor() {
                                ((this.onOutgoingMessage = new c()),
                                    (this.onIncomingMessage = new f()),
                    ...
                    function D(e) {
                        return S(this, void 0, void 0, function* () {
                            let t = i({
                                locateFile: (t, r) =>
                                    t.endsWith('zappar-cv.wasm') ? e : r + t,
                                onRuntimeInitialized: () => {
                                    let e = (function (e) {
                                            let t = e.cwrap(
                                                ...
                                                r = e.cwrap('zappar_log_level_set', null, [
                                                    'number',
                                                ]),
                                                a = e.cwrap(
                                                    'zappar_analytics_project_id_set',
                                                    null,
                                                    ['string', 'string']
                                                ),
                                                n = e.cwrap(
                                                    'zappar_pipeline_create',
                                                    'number',
                                                    []
                                                ),
                                                i = e.cwrap(
                                                    'zappar_pipeline_destroy',
                                                    null,
                                                    ['number']
                                                ),
                                                o = e.cwrap(
                                                    'zappar_pipeline_frame_update',
                                                    null,
                                                    ['number']
                                                ),
                                                s = e.cwrap(
                                                    'zappar_pipeline_frame_number',
                                                    'number',
                                                    ['number']
                                                ),
                                                _ = e.cwrap(
                                                    'zappar_pipeline_camera_model',
                                                    'number',
                                                    ['number']
                                                ),
                                                c = e.cwrap(
                                                    'zappar_pipeline_camera_frame_user_data',
                                                    'number',
                                                    ['number']
                                                ),
                                                f = e.cwrap(
                                                    'zappar_pipeline_camera_frame_submit',
                                                    null,
                                                    [
                                                        'number',
                                                        'number',
                                                ...
                                                u = e.cwrap(
                                                    'zappar_pipeline_camera_frame_submit_raw_pointer',
                                                    null,
                                                    [
                                                        'number',
                                                        'number',
                                                ...
                                                d = e.cwrap(
                                                    'zappar_pipeline_motion_accelerometer_submit',
                                                    null,
                                                    [
                                                        'number',
                                                        'number',
                                                ...
                                                h = e.cwrap(
                                                    'zappar_pipeline_motion_rotation_rate_submit',
                                                    null,
                                                    [
                                                        'number',
                                                        'number',
                                                ...
                                                m = e.cwrap(
                                                    'zappar_pipeline_motion_attitude_submit',
                                                    null,
                                                    [
                                                        'number',
                                                        'number',
                                                ...
                                                b = e.cwrap(
                                                    'zappar_pipeline_motion_attitude_matrix_submit',
                                                    null,
                                                    ['number', 'number']
                                                ),
                                                g = e.cwrap(
                                                    'zappar_camera_source_create',
                                                    'number',
                                                    ['number', 'string']
                                                ),
                                                w = e.cwrap(
                                                    'zappar_camera_source_destroy',
                                                    null,
                                                    ['number']
                                                ),
                                                y = e.cwrap(
                                                    'zappar_sequence_source_create',
                                                    'number',
                                                    ['number']
                                                ),
                                                v = e.cwrap(
                                                    'zappar_sequence_source_destroy',
                                                    null,
                                                    ['number']
                                                ),
                                                E = e.cwrap(
                                                    'zappar_image_tracker_create',
                                                    'number',
                                                    ['number']
                                                ),
                                                A = e.cwrap(
                                                    'zappar_image_tracker_destroy',
                                                    null,
                                                    ['number']
                                                ),
                                                T = e.cwrap(
                                                ...
                                                x = e.cwrap(
                                                    'zappar_image_tracker_enabled',
                                                    'number',
                                                    ['number']
                                                ),
                                                k = e.cwrap(
                                                    'zappar_image_tracker_enabled_set',
                                                    null,
                                                    ['number', 'number']
                                                ),
                                                L = e.cwrap(
                                                    'zappar_image_tracker_anchor_count',
                                                    'number',
                                                    ['number']
                                                ),
                                                F = e.cwrap(
                                                    'zappar_image_tracker_anchor_id',
                                                    'string',
                                                    ['number', 'number']
                                                ),
                                                z = e.cwrap(
                                                    'zappar_image_tracker_anchor_pose_raw',
                                                    'number',
                                                    ['number', 'number']
                                                ),
                                                M = e.cwrap(
                                                    'zappar_face_tracker_create',
                                                    'number',
                                                    ['number']
                                                ),
                                                I = e.cwrap(
                                                    'zappar_face_tracker_destroy',
                                                    null,
                                                    ['number']
                                                ),
                                                O = e.cwrap(
                                                    'zappar_face_tracker_model_load_from_memory',
                                                    null,
                                                    ['number', 'number', 'number']
                                                ),
                                                P = e.cwrap(
                                                ...
                                                S = e.cwrap(
                                                    'zappar_face_tracker_enabled_set',
                                                    null,
                                                    ['number', 'number']
                                                ),
                                                B = e.cwrap(
                                                    'zappar_face_tracker_enabled',
                                                    'number',
                                                    ['number']
                                                ),
                                                C = e.cwrap(
                                                    'zappar_face_tracker_max_faces_set',
                                                    null,
                                                    ['number', 'number']
                                                ),
                                                D = e.cwrap(
                                                    'zappar_face_tracker_max_faces',
                                                    'number',
                                                    ['number']
                                                ),
                                                U = e.cwrap(
                                                    'zappar_face_tracker_anchor_count',
                                                    'number',
                                                    ['number']
                                                ),
                                                V = e.cwrap(
                                                    'zappar_face_tracker_anchor_id',
                                                    'string',
                                                    ['number', 'number']
                                                ),
                                                N = e.cwrap(
                                                    'zappar_face_tracker_anchor_pose_raw',
                                                    'number',
                                                    ['number', 'number']
                                                ),
                                                G = e.cwrap(
                                                ...
                                                H = e.cwrap(
                                                    'zappar_face_mesh_create',
                                                    'number',
                                                    []
                                                ),
                                                q = e.cwrap(
                                                    'zappar_face_mesh_destroy',
                                                    null,
                                                    ['number']
                                                ),
                                                Y = e.cwrap(
                                                    'zappar_face_landmark_create',
                                                    'number',
                                                    ['number']
                                                ),
                                                X = e.cwrap(
                                                    'zappar_face_landmark_destroy',
                                                    null,
                                                    ['number']
                                                ),
                                                Z = e.cwrap(
                                                    'zappar_barcode_finder_create',
                                                    'number',
                                                    ['number']
                                                ),
                                                j = e.cwrap(
                                                    'zappar_barcode_finder_destroy',
                                                    null,
                                                    ['number']
                                                ),
                                                K = e.cwrap(
                                                    'zappar_barcode_finder_enabled_set',
                                                    null,
                                                    ['number', 'number']
                                                ),
                                                J = e.cwrap(
                                                    'zappar_barcode_finder_enabled',
                                                    'number',
                                                    ['number']
                                                ),
                                                $ = e.cwrap(
                                                    'zappar_barcode_finder_found_number',
                                                    'number',
                                                    ['number']
                                                ),
                                                Q = e.cwrap(
                                                    'zappar_barcode_finder_found_text',
                                                    'string',
                                                    ['number', 'number']
                                                ),
                                                ee = e.cwrap(
                                                    'zappar_barcode_finder_found_format',
                                                    'number',
                                                    ['number', 'number']
                                                ),
                                                te = e.cwrap(
                                                    'zappar_barcode_finder_formats',
                                                    'number',
                                                    ['number']
                                                ),
                                                re = e.cwrap(
                                                    'zappar_barcode_finder_formats_set',
                                                    null,
                                                    ['number', 'number']
                                                ),
                                                ae = e.cwrap(
                                                    'zappar_instant_world_tracker_create',
                                                    'number',
                                                    ['number']
                                                ),
                                                ne = e.cwrap(
                                                    'zappar_instant_world_tracker_destroy',
                                                    null,
                                                    ['number']
                                                ),
                                                ie = e.cwrap(
                                                    'zappar_instant_world_tracker_enabled_set',
                                                    null,
                                                    ['number', 'number']
                                                ),
                                                oe = e.cwrap(
                                                    'zappar_instant_world_tracker_enabled',
                                                    'number',
                                                    ['number']
                                                ),
                                                se = e.cwrap(
                                            ...
                                            return {
                                                log_level: () => t(),
                                                log_level_set: (e) => r(e),
                                                analytics_project_id_set: (e, t) => a(e, t),
                                                pipeline_create: () => n(),
                                                pipeline_destroy: () => {
                                                    i();
                                                },
                                                ...
                                                pipeline_camera_frame_submit: (
                                                    ...
                                                    let c = fe,
                                                        u = r.byteLength;
                                                    e.HEAPU8.set(new Uint8Array(r), fe);
                                                    let l = a,
                                                        p = n,
                                                        d = i,
                                                        h = le(4, o.byteLength);
                                                ...
                                                pipeline_camera_frame_camera_attitude: (
                                                    t
                                                ) => {
                                                    let r = l(t),
                                                ...
                                                pipeline_motion_attitude_matrix_submit: (
                                                    t,
                                                    r
                                                ) => {
                                                    let a = le(0, r.byteLength);
                                                    return (
                                                        e.HEAPF32.set(r, a / 4),
                                                        b(t, a)
                                                    );
                                                },
                                                camera_source_create: (e, t) => g(e, t),
                                                ...
                                                face_tracker_model_load_from_memory: (
                                                    t,
                                                    r
                                                ) => {
                                                    ce < r.byteLength &&
                                                ...
                                                barcode_finder_formats_set: (e, t) =>
                                                    re(e, t),
                                                instant_world_tracker_create: (e) => ae(e),
                                                ...
                                                instant_world_tracker_anchor_pose_set_from_camera_offset_raw:
                                                    (e, t, r, a, n) => _e(e, t, r, a, n),
                                            };
                                        })(t),
                                        r = new _(e, (e, t) => {
                                            B.postOutgoingMessage(
                                                {p: e, t: 'zappar', d: t},
                                                [t]
                                            );
                                        });
                                    (B.postOutgoingMessage('loaded', []),
                                        B.onIncomingMessage.bind((a) => {
                                            var n;
                                            switch (a.t) {
                                                case 'zappar':
                                                    (r.processBuffer(a.d),
                                                ...
                                                case 'buf':
                                                    null ===
                                                        (n = r.serializersByPipelineId.get(
                                                            a.p
                                                        )) ||
                                                        void 0 === n ||
                                                        n.bufferReturn(a.d);
                                                ...
                                                case 'imageBitmapC2S':
                                                    !(function (e, t, r, a) {
                                                        const [n, i] = (function () {
                                                            if (!M || !I) {
                                                                ...
                                                                if (
                                                                    ...
                                                                    throw new Error(
                                                                        'Unable to get offscreen GL context'
                                                                    );
                                                                M = new L(I);
                                                            }
                                                            return [M, I];
                                                        ...
                                                        a.postOutgoingMessage(s, [e.i]);
                                                        let _ = r._pipeline_by_instance.get(
                                                            e.p
                                                        );
                                                        _ &&
                    ...
                    let U = 0,
                        ...
                        N = 1;
                    const G = b.Ue(),
                        W = new Float32Array([300, 300, 160, 120, 0, 0]);
                    function H(e) {
                        switch (e) {
                            case 'I420':
                                return h.FRAME_PIXEL_FORMAT_I420;
                            case 'I420A':
                                return h.FRAME_PIXEL_FORMAT_I420A;
                            case 'I422':
                                return h.FRAME_PIXEL_FORMAT_I422;
                            case 'I444':
                                return h.FRAME_PIXEL_FORMAT_I444;
                            case 'NV12':
                                return h.FRAME_PIXEL_FORMAT_NV12;
                            case 'RGBA':
                            case 'RGBX':
                                return h.FRAME_PIXEL_FORMAT_RGBA;
                            case 'BGRA':
                            case 'BGRX':
                                return h.FRAME_PIXEL_FORMAT_BGRA;
                        }
                        return h.FRAME_PIXEL_FORMAT_Y;
                    }
                    const q = self;
                    B.onOutgoingMessage.bind(() => {
                        let e = B.getOutgoingMessages();
                        for (let t of e) q.postMessage(t.msg, t.transferables);
                    });
                    let Y = (e) => {
                        e &&
                            e.data &&
                            ...
                            (D(
                                location.href.startsWith('blob')
                                    ? e.data.url
                                    : new URL(r(751), r.b).toString()
                            ),
                            q.removeEventListener('message', Y));
                    };
                    (q.addEventListener('message', Y),
                        q.addEventListener('message', (e) => {
                            B.postIncomingMessage(e.data);
                        }));
                },
                751: (e, t, r) => {
        ...
        return (
            ...
            (n.O = (t, r, a, i) => {
                if (!r) {
                    ...
                    for (f = 0; f < e.length; f++) {
                        for (var [r, a, i] = e[f], s = !0, _ = 0; _ < r.length; _++)
                            (!1 & i || o >= i) &&
                            Object.keys(n.O).every((e) => n.O[e](r[_]))
                                ? r.splice(_--, 1)
                                : ((s = !1), i < o && (o = i));
                        if (s) {
                            e.splice(f--, 1);
            ...
            (() => {
                ...
                var t = (self.webpackChunkZCV = self.webpackChunkZCV || []),
                    r = t.push.bind(t);
                t.push = (t) => {
                    var [a, i, o] = t;
