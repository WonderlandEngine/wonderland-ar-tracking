...
// js/camera-switch-ui.ts
var XR8CameraSwitch = class extends Component2 {
  _faceTrackingCamera;
  _imageTrackingCamera;
  _worldTrackingCamera;
  start() {
...
__publicField(XR8CameraSwitch, "TypeName", "xr8-camera-switch-example");
...
// js/slam-tracking-example.ts
var SlamTrackingExample = class extends Component2 {
  ARSlamCamera;
  start() {
...
__publicField(SlamTrackingExample, "TypeName", "slam-tracking-example");
__decorateClass([
  property2.object()
], SlamTrackingExample.prototype, "ARSlamCamera", 2);
...
//# sourceMappingURL=CameraSwitch-bundle.js.map
